...
public class XMLGenerator {
	...
	public String generate(CMElementDeclaration elementDeclaration, String prefix, boolean generateEndTag) {
		...
		generate(elementDeclaration, prefix, generateEndTag, false, 0, 0, xml, new ArrayList<CMElementDeclaration>(), new ArrayList<String>());
	...
	/**
	 * Returns the XML generated from the given element declaration given option to generate only children.
	 * @param elementDeclaration
	 * @param prefix
	 * @param generateEndTag
	 * @param generateOnlyChildren true if only is children of the given element is to be generated
	 * @param existingElementNames a collection of strings of element names that already exist in the XML
	 * @return the XML generated from the given element declaration given option to generate only children.
	 */
	public String generate(CMElementDeclaration elementDeclaration, String prefix, boolean generateEndTag,
	...
	private int generate(CMElementDeclaration elementDeclaration, String prefix, boolean generateEndTag,
			...
			int snippetIndex, XMLBuilder xml, List<CMElementDeclaration> generatedElements, Collection<String> existingElementNames) {
		...
		if (generatedElements.contains(elementDeclaration) || existingElementNames.contains(elementDeclaration.getName())) {
			return snippetIndex;
		}
